...
const main = create('main', '',
    ...
    create('p', 'hint', 'Use left <kbd>Ctrl</kbd> + <kbd>Alt</kbd> to switch language. Last language saves to LocalStorage'),
    create('span', 'show-kbd', create('img', 'kbd_img', null, null, ['src', 'assets/tia.png'])),
    create('audio', 'audio', null, null, ['src', 'assets/button.mp3']),
    create('audio', 'audio', null, null, ['src', 'assets/sound.mp3']),
    create('audio', 'audio', null, null, ['src', 'assets/caps.mp3']),
    create('audio', 'audio', null, null, ['src', 'assets/shift.mp3']),
    create('audio', 'audio', null, null, ['src', 'assets/backspace.mp3'])
    ]);
...
export default class Keyboard {
    ...
    generateLayout() {
        ...
        document.querySelector('.show-kbd').addEventListener('click', () => {
            document.querySelector('.show-kbd').classList.toggle('show-kbd_active');
            this.container.classList.toggle('keyboard_active');
        });
    }
